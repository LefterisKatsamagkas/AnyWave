...
export default function HomePage() {
    ...
    useEffect(() => {
        const fetchFavoriteBeaches = async () => {
            try {
                ...
                const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/beaches/liked-beaches`, { user_id: user.id });
    ...
    const handleSearch = async (input) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/weather`, { searchQuery: input });
    ...
    const handleBeachClicked = async (input) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/weather`, { latitude, longitude, placeName});
